...
$(function() { 
  ...
  $('.filter-dropdown-subject').on( 'change', function() { // When a filter button is clicked on...
  ...
  // Filtering interaction with dropdown
  $('.filter-dropdown-impressionist-artist').on( 'change', function() { // When a filter button is clicked on...
    let filterValue = this.value; // Get it's data-filter value
    // try console.log filterValue to see what gets displayed in the browser console
    $grid.isotope({ filter: filterValue }); // Pass the value to the isotope array object
  });
  ...
  // Filtering interaction with dropdown
  $('.filter-dropdown-postimpressionist-artist').on( 'change', function() { // When a filter button is clicked on...
    let filterValue = this.value; // Get it's data-filter value
    // try console.log filterValue to see what gets displayed in the browser console
    $grid.isotope({ filter: filterValue }); // Pass the value to the isotope array object
  });
